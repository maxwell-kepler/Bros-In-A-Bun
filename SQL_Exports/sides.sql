...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2023 at 07:56 PM
...
('Doritos', '2023-03-30 18:58:10'),
('Fries', '2023-03-30 18:58:00');
...
--
ALTER TABLE `sides`
  ADD CONSTRAINT `FOREIGN_KEY1` FOREIGN KEY (`Item_name`) REFERENCES `inventory` (`Item_name`);
COMMIT;
